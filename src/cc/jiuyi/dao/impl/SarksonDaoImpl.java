 ...
 */
@Repository
public class SarksonDaoImpl extends BaseDaoImpl<SarkSon, String> implements SarksonDao
{

	@Override
	public Pager historyjqGrid(Pager pager, HashMap<String, String> map) {
		DetachedCriteria detachedCriteria = DetachedCriteria
				.forClass(SarkSon.class);
		pagerSqlByjqGrid(pager, detachedCriteria);
		if (!existAlias(detachedCriteria, "sark", "sark")) {
			detachedCriteria.createAlias("sark", "sark");
		}
		if (map.size() > 0) {
...
//					end = DateUtils.addDays(end, 1);
	...
	public List<Object[]> historyExcelExport(HashMap<String, String> map) {
			String hql="from SarkSon model join model.sark model1";
			Integer ishead=0;
