...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/post.js"></script>
				...
				<div class="page-content">
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" id="searchform" action="post!ajlist.action" role="form">
								   ...
								   <div class="form-group">
									  ...
									  <div class="col-sm-4">
										<select name="post.state">
								            ...
								            <option value="${list.dictkey}"<#if ((isAdd && list.isDefault) || (isEdit && post.state == list.dictkey))!> selected</#if>>${list.dictvalue}</option>
							                </#list>
						               </select>
									  </div>
