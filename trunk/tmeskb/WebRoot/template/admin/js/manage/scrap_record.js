jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
	        ...
	        {name:'workingbillCode',index:'workingbillCode', label:"随工单编号", width:300,sortable:"true",sorttype:"text"},
	        {name:'maktx',index:'maktx',label:"产品名称", width:500,sortable:"true",sorttype:"text"},
	        {name:'factory',index:'factory',label:"工厂", width:300,sortable:"true",sorttype:"text"},
	        {name:'workshop',index:'workshop',label:"车间", width:300,sortable:"true",sorttype:"text"},
	        {name:'location',index:'location',label:"库存地点", width:300,sortable:"true",sorttype:"text"},
	        {name:'createDate',label:"入库时间",width:400,index:'createDate', editable: false,sortable:"true",sorttype:"date",unformat: pickDate,formatter:datefmt},
	...
	$("#btn_show").click(function(){
		if(getId2())
		{
			location.href="enteringware_house!view.action?id="+id;
		}
	});
