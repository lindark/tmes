...
<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">文章分类列表&nbsp;<span class="pageInfo">总记录数: ${articleCategoryTreeList?size}</span></li>
		</ul><!-- /.breadcrumb -->
	</div>
	...
	<div class="page-content">
		...
		<form id="listForm" class="pdl10" action="article_category!list.action" method="post">
			<div class="operateBar">
			
				<a id="addButton" class="btn btn-white btn-sm btn-info btn-round" href="article_category!add.action">
