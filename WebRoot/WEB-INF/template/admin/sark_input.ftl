...
<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/sark_input.js"></script>
<style>
body {
	background: #fff;
}
								...
								<div id="inputtabs">
									...
									<div id="tabs-1" class="tab1">	
									  <div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
											            <#if show>													
																${(sark.bktxt)!}
														<#else>
														<input type="text" name="bktxt" id="bktxt" value="${(sark.bktxt)!}" class=" input input-sm  formText {required: true,minlength:1,maxlength: 5}" />
										...
										<div class="profile-user-info profile-user-info-striped">
								  			<div class="profile-info-row">
								    			<table id="tb_sarkson" class="table table-striped table-bordered table-hover">
													<tr>
...
$(function(){
	...
	$("#btn_save").click(function(){
		...
		var url="";
		<#if add??>
			url = "sark!creditsave.action";		
		<#else>
			url = "sark!creditupdate.action";
		</#if>
		save_event(url);
	});
});
