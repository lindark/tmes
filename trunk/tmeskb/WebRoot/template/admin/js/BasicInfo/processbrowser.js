jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colNames:['id','车间编码','工序名称'],
		colModel:[
		    {name:'id',index:'id', sorttype:"int",label:"ID", editable: false,hidden:true},
			{name:'processCode',index:'processCode', width:240,editable: true,editoptions:{size:"20",maxlength:"30"}},
			{name:'processName',index:'processName', width:160,editable: true,editoptions:{size:"20",maxlength:"30"}}				
