...
public class AdminAction extends BaseAdminAction {
	...
	private String[] strlen = {"workingBillCode","materialCode","planCount","afteroddamount","afterunoddamount","recipientsAmount","multiple","totalSingleAmount",
			...
			"trzsl","cczsl","slcy","jhdcl","matnr","maktx","materialName","totalAmount","isHand","jycl","xFactoryUnit","teamCode","teamName","bulkProductMount","needAttendance","actulAttendance"};
	private String[] lavenlen={"随工单编号","子件编码","计划数量","接上班零头数","接上班异常零头数","领用数","倍数","入库数",
			...
			"投入总数量","产出总数量","数量差异","计划达成率","物料编码","物料描述","组件描述","当班报工数","单据状态","校验差异","单元","班组编码","班组名称","待包装数量","应出勤人数","实出勤人数"};
