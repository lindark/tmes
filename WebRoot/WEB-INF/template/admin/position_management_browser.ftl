...
<link href="${base}/template/admin/css/input.css" rel="stylesheet"
	type="text/css" />
<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/unitdistribute_model.js"></script>
								...
								<div class="operateBar">
									<div class="form-group">
										<label class="col-sm-2"
											style="text-align:right;">单元编码:</label>
										<div class="col-sm-4">
											<input type="text" name="factoryUnitCode"
										...
										<div class="col-sm-4">
											<input type="text" name="factoryUnitName"
												class="input input-sm form-control" value=""
												id="form-field-icon-1">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-2"
											style="text-align:right;">车间名称:</label>
										<div class="col-sm-4">
										...
										<label class="col-sm-2" style="text-align:right;">工厂名称:</label>
										<div class="col-sm-4">
...
<script type="text/javascript">
	function getGridId(){
		...
		var rowName=rowData.factoryUnitName;
		var rowCode=rowData.factoryUnitCode;
