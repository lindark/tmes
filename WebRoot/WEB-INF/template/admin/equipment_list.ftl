							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" id="searchform" action="factory!ajlist.action" role="form">
								   ...
								   <div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="equipmentNo" class="input input-sm form-control" value="" id="form-field-icon-1">
										</div>
										
										
										<label class="col-sm-1" style="text-align:right">设备名称:</label>
										<div class="col-sm-4">
											<input type="text" name="equipmentName" class="input input-sm form-control" value="" id="form-field-icon-2">
										</div>
									</div>
