...
<script type="text/javascript"
	src="${base}/template/admin/js/manage/enter_history.js"></script>
<script type="text/javascript"
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="searchform"
								action="end_product!historylist.action" role="form">
  ...
  $(function(){
	  var $excelReport = $("#excelReport");
	   ...
	   $excelReport.click(function(){
		   $searchform.attr("action","end_product!excelexport.action");
		   $searchform.submit();
	   });	   
