...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/repair_detail.js"></script>
				...
				<div class="page-content">
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" id="searchform" action="repair_detail!ajlist.action" role="form">
								   ...
								   <div class="form-group">
										...
										<label class="col-sm-1" style="text-align:right">返修部位名称:</label>
										<div class="col-sm-4">
