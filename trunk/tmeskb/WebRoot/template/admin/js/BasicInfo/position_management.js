jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"position_management!ajlist.action",
		datatype: "json",
...
//            {name:'xfactoryUnitName',index:'factoryUnit.factoryUnitName',editable: true,sortable:true,search:true},
		...
		editurl: "position_management!delete.action",//用它做标准删除动作
		caption: "单元仓位管理"
	...
	jQuery(grid_selector).jqGrid('navGrid',pager_selector,
		{ 	//navbar options
		    ...
		    editfunc:function(rowId){
			    ...
			    window.location.href="position_management!edit.action?id="+rowId;
		    },
			editicon : 'ace-icon fa fa-pencil blue',
			//add: true,
			addfunc:function(){
				window.location.href="position_management!add.action";
			},
