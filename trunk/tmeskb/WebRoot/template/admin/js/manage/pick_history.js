jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[		
	        ...
	        {name:'maktx',index:'workingbill.maktx',label:"产品名称", width:300,sortable:"true",sorttype:"text"},
	        {name:'xpickType',index:'pickType',label:"领/退类型", width:70,sortable:"true",sorttype:"text"},
