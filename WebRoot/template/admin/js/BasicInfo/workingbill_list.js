...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"working_bill!ajlist.action",
		datatype: "json",
		...
		colModel:[
			...
			{name:'planCount',label:"生产数量",width:100,index:'planCount', editable: false},
			{name:'workcenter',label:"工作中心",width:100,index:'workcenter', editable: false},
			{name:'module',label:"模具",width:100,index:'module', editable: false},
