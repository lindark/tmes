jQuery(function($){
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
			...
			{name:'isRepair',index:'isRepair',label:"返修发货",width:200,sortable:"true",sorttype:"text",editable: true,search:true,searchoptions:{dataUrl:"dict!getDict1.action?dict.dictname=materialIsRepair"}},
			...
			{name:'xfactory',index:'factoryunit.workShop.factory.factoryName',label:"工厂名称", width:200,editable: true},
