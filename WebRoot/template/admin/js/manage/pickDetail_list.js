...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
	    ...
	    colModel:[
					{name:'materialCode',index:'materialCode',label:"组件编码",width:100,editable: true},
					{name:'materialName',index:'materialName',label:"组件名称", width:150,search:true,editable: true},
					{name:'createDate',index:'createDate',label:"时间",width:150,editable: true},
					{name:'confirmUser',index:'confirmUser',label:"确认人",width:100,editable: true},				
