						...
						<div class="col-xs-12">
							<!-- ./ add by welson 0728 -->							
                             <fieldset id="self-data">
													    <div class="form">
												        <select name="type" class="type select"  data-first-title="---选择类型---" data-value="" data-url="longtime_preventstep!getType.action" data-json-space="type"></select>
												        <select name="longSet.id" class="longPrevent select child"  data-first-title="---选择处理方法---" data-value="" data-url="longtime_preventstep!getAll.action" data-json-space="longPrevent"></select>												  		
												        </div>
							</fieldset>
