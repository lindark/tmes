...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/cardManagement.js"></script>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" id="searchform" action="process!ajlist.action" role="form">
								   ...
								   <div class="form-group">
										...
										<label class="col-sm-1" style="text-align:right">电脑IP:</label>
										<div class="col-sm-4">
											<input type="text" name="pcIp" class="input input-sm form-control" value="" id="form-field-icon-1">
										</div>
									</div>
									  ...
									  <div class="col-sm-4">
										<select name="cardManagement.state">
								            ...
								            <option value="${list.dictkey}"<#if ((isAdd && list.isDefault) || (isEdit && cardManagement.state == list.dictkey))!> selected</#if>>${list.dictvalue}</option>
							                </#list>
						               </select>
									  </div>
