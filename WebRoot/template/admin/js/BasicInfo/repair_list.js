	...
	jQuery(grid_selector).jqGrid(
			{
				...
				colNames : [ '单据编号', '产品编号', '产品名称', '返修部位', '返修数量', '累计数量',
						'责任工序', '责任人/批次', '日期', '确认人', '状态' ],
				colModel : [
	...
	jQuery(grid_selector).jqGrid(
			...
			{ // navbar options
				...
				editfunc : function(rowId) {
					window.location.href = "repair!edit.action?id=" + rowId;
				},
				editicon : 'ace-icon fa fa-pencil blue',
				// add: true,
				addfunc : function() {
					window.location.href = "repair!add.action";
				},
				addicon : 'ace-icon fa fa-plus-circle purple',
				del: true,
				/*delfunc : function(rowId) {
					window.location.href = "repair!delete.action?id=" + rowId;
				},*/
