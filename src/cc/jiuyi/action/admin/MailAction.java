...
import cc.jiuyi.service.MailService;
...
public class MailAction extends BaseAdminAction {
	...
	@Validations(
		requiredStrings = { 
			...
			@RequiredStringValidator(fieldName = "smtpUsername", message = "SMTP登录名不允许为空!"),
	...
	public String ajaxSendSmtpTest() {
		try {
			...
			return ajaxJsonErrorMessage("权限验证失败，请检查SMTP登录名、密码！");
