...
<title>产品类型列表 - Powered By ${systemConfig.systemName}</title>
...
<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">产品类型列表&nbsp;<span class="pageInfo">总记录数: ${pager.totalCount}(共${pager.pageCount}页)</span></li>
		</ul><!-- /.breadcrumb -->
	</div>
	...
	<div class="page-content">
		...
		<form id="listForm" class="pdl10" action="product_type!list.action" method="post">
			<div class="operateBar">
			
			
				<a id="addButton" class="btn btn-white btn-sm btn-info btn-round" href="product_type!add.action">
			...
			<#if (pager.list?size > 0)>
				<div class="pagerBar">
					<input type="button" class="deleteButton btn btn-white btn-default btn-sm btn-round " url="product_type!delete.action" value="删 除" disabled hidefocus="true" />
