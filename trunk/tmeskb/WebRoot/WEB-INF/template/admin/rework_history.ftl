...
<script type="text/javascript"
	src="${base}/template/admin/js/manage/rework_history.js"></script>
<script type="text/javascript"
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="searchform" method="post"
								action="action!historylist.action" role="form">
...
<script type ="text/javascript">
   $(function(){
	   ...
	   $excelReport.click(function(){
		   $searchform.attr("action","rework!excelexport.action");
		   $searchform.submit();
	   });	   
   })
