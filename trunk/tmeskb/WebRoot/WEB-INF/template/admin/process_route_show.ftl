...
<script type="text/javascript"
	src="${base}/template/admin/js/BasicInfo/process_route.js"></script>
<script type="text/javascript"
...
<body class="no-skin list">
	...
	<div class="main-container" id="main-container">
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="searchform"
								...
								<div class="operateBar">
									...
									<div class="form-group">
										<label class="col-sm-1 col-md-offset-1"
											style="text-align:right">工序编码:</label>
										<div class="col-sm-4">
		...
		<#include "/WEB-INF/template/admin/admin_footer.ftl"> <#include
		"/WEB-INF/template/common/include_adm_bottom.ftl"> <a href="#"
