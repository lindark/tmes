...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/factoryUnit.js"></script>
				...
				<div class="page-content">
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" id="searchform" action="factory_unit!ajlist.action" role="form">
								   <div class="operateBar">
								   <div class="form-group">
										<label class="col-sm-1 col-md-offset-1" style="text-align:right">单元编码:</label>
										<div class="col-sm-4">
