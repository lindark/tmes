...
<script type="text/javascript"
	src="${base}/template/admin/js/manage/itermediatetest_history.js"></script>
<script type="text/javascript"
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="searchform" method="post"
								action="itermediate_test!historylist.action" role="form">
								<div class="operateBar">
									<div class="form-group">
										...
										<label class="col-sm-1 col-md-offset-1"
											style="text-align:right">组件名称:</label>
										<div class="col-sm-4">
									...
									<div class="col-sm-4">
										<input type="text" name="xcreateUser"
											class="input input-sm form-control" value=""
											id="form-field-icon-1">
									</div>
										...
										<div class="col-sm-4">
											<input type="text" name="xconfirmUser"
												class="input input-sm form-control" value=""
												id="form-field-icon-1">
										</div>
									</div>
...
<script type="text/javascript">
	$(function() {
		...
		$excelReport.click(function() {
			$searchform.attr("action", "itermediate_test!excelexport.action");
			$searchform.submit();
		});
	})
</script>
