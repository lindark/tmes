...
<link href="${base}/template/common/css/jquery-ui.min.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${base}/template/common/js/jquery-migrate-1.2.1.js"></script>
...
<script type="text/javascript" src="${base}/template/common/tiny_mce/tinymce.min.js"></script>
<script type="text/javascript" src="${base}/template/common/tiny_mce/jquery.tinymce.min.js"></script>
<!--[if lte IE 6]>
