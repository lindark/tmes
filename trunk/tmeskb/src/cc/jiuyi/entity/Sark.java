 ...
 */
@Entity
public class Sark extends BaseEntity {

	private static final long serialVersionUID = -8927337834611798560L;
	private Integer sarkAmount;// 纸箱总数量
	...
	private Set<SarkSon>sarksonSet;//纸箱收货-子表
	...
	public Integer getSarkAmount() {
		return sarkAmount;
	}

	public void setSarkAmount(Integer sarkAmount) {
		if(sarkAmount==null)
		{
			sarkAmount=0;
		}
		this.sarkAmount = sarkAmount;
	}
	...
	@OneToMany(fetch=FetchType.LAZY,mappedBy="sark")
	public Set<SarkSon> getSarksonSet()
	{
		return sarksonSet;
	}

	public void setSarksonSet(Set<SarkSon> sarksonSet)
	{
		this.sarksonSet = sarksonSet;
	}
