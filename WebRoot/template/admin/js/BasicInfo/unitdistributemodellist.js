jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"unitdistribute_model!ajlist.action",
		datatype: "json",
	...
	jQuery(grid_selector).jqGrid('navGrid',pager_selector,
		{ 	//navbar options
		    ...
		    editfunc:function(rowId){
			    ...
			    window.location.href="unitdistribute_model!edit.action?id="+rowId;
		    },
			editicon : 'ace-icon fa fa-pencil blue',
			//add: true,
			addfunc:function(){
				window.location.href="unitdistribute_model!add.action";
			},
