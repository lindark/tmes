jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"workbinson!historylist.action",
		datatype: "json",
		//mtype:"POST",//提交方式
		...
		colModel:[
        	...
        	{name:'bktxt',index:'workbin.bktxt', width:50,sortable:"true",sorttype:"text"},
			...
			{name:'stateRemark',index:'state', width:40,cellattr:addstyle,sortable:"true",sorttype:"text",editable: true,search:true,stype:"select",searchoptions:{dataUrl:"dict!getDict1.action?dict.dictname=workbinState"}},
		...
		editurl: "workbinson!delete.action",//用它做标准删除动作
		caption: "纸箱收货记录"
