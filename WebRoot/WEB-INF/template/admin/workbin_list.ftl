...
<script type="text/javascript"
	src="${base}/template/admin/js/manage/workbin_list.js"></script>
<script type="text/javascript"
					...
					<div class="row">
						<div class="col-xs-12">
								...
								<div class="operateBar">
									<div class="form-group">
										<label class="col-sm-1 col-md-offset-1"
											style="text-align:right">交货单号:</label>
										<div class="col-sm-4">
											<input type="text" name="oderNumber"
												class="input input-sm form-control" value=""
												id="form-field-icon-1">
										</div>
										<label class="col-sm-1  col-md-offset-1" style="text-align:right">确认日期:</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
									 <label class="col-sm-1 col-md-offset-1"
											style="text-align:right">料箱编码:</label>
										<div class="col-sm-4">
									...
									<label class="col-sm-1 col-md-offset-1"
											style="text-align:right">料箱描述:</label>
										<div class="col-sm-4">
											<input type="text" name="matnrdesc"
												class="input input-sm form-control" value=""
												id="form-field-icon-1">
										</div>
							...
							<!-- 	<a id="btn_confirm" class="btn btn-white btn-default btn-sm btn-round">
								...
								<a id="btn_cancel" class="btn btn-white btn-default btn-sm btn-round">
									<i class="ace-icon fa fa-cloud-upload"></i>
									刷卡撤销
								</a>
...
<script type="text/javascript">
     $(function(){
    	 ...
    	 $excelReport.click(function(){
    		 $searchform.attr("action","repairin!excelexport.action");
  		     $searchform.submit();
    	 });
     })
