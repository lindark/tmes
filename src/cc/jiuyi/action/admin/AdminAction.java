...
public class AdminAction extends BaseAdminAction {
	...
	private String[] strlen = {"workingBillCode","materialCode","planCount","afteroddamount","afterunoddamount","recipientsAmount","multiple","totalSingleAmount","afterFraction","scrapNumber",
			"totalRepairAmount","totalRepairinAmount","productDate","shift","aufnr","zjdwyl","dbjyhgs","beforeunoddamount","ychgl","trzsl",
			"cczsl","slcy","jhdcl","matnr","maktx","materialName","totalAmount","isHand","jycl","xFactoryUnit",
	...
	private String[] lavenlen={"随工单编号","子件编码","计划数量","接上班零头数","接上班异常零头数","领用数","倍数","包装数",
			...
			"应出勤人数","实出勤人数","主任","副主任","部长","副总","工作小时","入库数","偏差","差异/入库","产出汇总/入库","生产数/入库","生产合格数"};
