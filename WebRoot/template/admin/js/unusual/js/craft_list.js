...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"craft!ajlist.action?abnormalId="+$("#unusualId").val(),
		datatype: "json",
...
function btn_event()
{
	...
	$("#btn_edit").click(function(){
		...
		if(getId2())
		{
			...
			{
				window.location.href="craft!edit.action?id="+info;
			}
		}
	});
	//刷卡查看
	$("#btn_show").click(function(){
		...
		if(getId2())
		{
			window.location.href="craft!view.action?id="+info;
		}
	});
}
...
function getId()
{
	...
	if(info==null||info=="")
	{
		layer.alert("请选择至少一条工艺维修单！",false);
		return false;
	}
	return true;
}
