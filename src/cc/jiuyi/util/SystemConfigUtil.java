...
public class SystemConfigUtil {
	...
	public static SystemConfig getSystemConfig() {
		...
		Node shopNameNode = document.selectSingleNode("/tkwrdp/systemConfig/shopName");
		Node shopUrlNode = document.selectSingleNode("/tkwrdp/systemConfig/shopUrl");
		Node shopLogoNode = document.selectSingleNode("/tkwrdp/systemConfig/shopLogo");
