...
<link href="${base}/template/admin/css/input.css" rel="stylesheet"
	type="text/css" />
<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/admin_alert.js"></script>
							...
							<form class="form-horizontal" id="searchform" action="kaoqin!getemp.action" role="form">
								...
								<div class="operateBar">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="skill" class="input input-sm form-control" value="" id="form-field-icon-1">
										</div>
...
function getGridId()
{
	...
	else
	{
		for(var i=0;i<ids.length;i++)
		{
			...
			result+=rowData.name+"("+rowData.workNumber+"),";
		}
