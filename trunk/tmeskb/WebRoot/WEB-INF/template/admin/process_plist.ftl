...
<div class="main-container" id="main-container">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">角色管理&nbsp;<span class="pageInfo">总记录数: ${pager.totalCount}(共${pager.pageCount}页)</span></li>
		</ul><!-- /.breadcrumb -->
	</div>
					...
					<div class="page-content-area">					
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- ./ add by welson 0728 -->
								<!-- 
		<form id="listForm" class="pdl10" action="role!list.action" method="post">
...
<label class="label label-xlg label-white" style="background-color:#fff!important;color:#777;">每页显示:</label>
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							<a href="role!edit.action" title="编辑">[编辑]</a>
						</td>
					</tr>
				</#list>
			</table>
			<#if (pager.list?size > 0)>
				<div class="pagerBar">
					<input type="button" class="deleteButton btn btn-white btn-default btn-sm btn-round " url="role!delete.action" value="删 除" disabled hidefocus="true" />
