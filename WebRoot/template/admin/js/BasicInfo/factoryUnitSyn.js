jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"factory_unit_syn!ajlist.action",
		datatype: "json",
		...
		editurl: "factory_unit_syn!delete.action",//用它做标准删除动作
		caption: "单元同步管理"
	...
	jQuery(grid_selector).jqGrid('navGrid',pager_selector,
		{ 	//navbar options
		    ...
		    editfunc:function(rowId){
			    ...
			    window.location.href="factory_unit_syn!edit.action?id="+rowId;
		    },
			editicon : 'ace-icon fa fa-pencil blue',
			//add: true,
			addfunc:function(){
				window.location.href="factory_unit_syn!add.action";
			},
