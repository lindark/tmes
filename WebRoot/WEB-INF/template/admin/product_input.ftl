...
$().ready(function() {
	...
	$(".productImageUploadButton input").livequery("change", function() {
		...
		if (/(<#list systemConfig.allowedUploadImageExtension?split(stack.findValue("@cc.jiuyi.bean.SystemConfig@EXTENSION_SEPARATOR")) as list><#if list_has_next>.${list}|<#else>.${list}</#if></#list>)$/i.test($this.val()) == false) {
			$.message("您选择的文件格式错误！");
			return false;
		}
	...
	<div class="page-content">
						...
						<div class="row">
							...
							<div id="inputtabs">
											<ul>
												...
												<li>
													<a href="#tabs-2">产品描述</a>
												</li>

												<li>
													<a href="#tabs-3">产品属性</a>
												</li>
											</ul>
			...
			<table id="tabs-1" class="inputTable tabContent">
				...
				<tr>
					...
					<td>
						<input type="text" class="formText" name="product.productSn" value="${(product.productSn)!}" placeholder="SAP/ERP编码" />
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td>
						...
						<input type="button" name="syncLgort" class="btn btn-sm btn-default" value="同步库存" hidefocus="true" />
				...
				<tr>
					...
					<label class="pull-left inline">
						...
						<input type="radio" name="product.isBest" class="ace" value="true"<#if (product.isBest == true)!> checked</#if> />
					...
					<label class="pull-left inline">
						...
						<input type="radio" name="product.isBest" class="ace" value="false"<#if (isAdd || product.isBest == false)!> checked</#if> />
						<span class="lbl middle"></span>
					</label>			
				...
				<tr>
					...
					<label class="pull-left inline">
					    <small class="muted smaller-90">是:</small>
						<input type="radio" name="product.isNew" class="ace" value="true"<#if (product.isNew == true)!> checked</#if> />
						<span class="lbl middle"></span>
					</label>
					...
					<label class="pull-left inline">
					    ...
					    <small class="muted smaller-90">否:</small>
						<input type="radio" name="product.isNew" class="ace" value="false"<#if (isAdd || product.isNew == false)!> checked</#if> />
						<span class="lbl middle"></span>
					</label>
				...
				<tr>
					...
					<label class="pull-left inline">
					    <small class="muted smaller-90">是:</small>
						<input type="radio" name="product.isHot" class="ace" value="true"<#if (product.isHot == true)!> checked</#if> />
						<span class="lbl middle"></span>
					</label>
					...
					<label class="pull-left inline">
					    ...
					    <small class="muted smaller-90">否:</small>
						<input type="radio" name="product.isHot" class="ace" value="false"<#if (isAdd || product.isHot == false)!> checked</#if> />
						<span class="lbl middle"></span>
					</label>
					</td>
				</tr>
				<tr>
					...
					<label class="pull-left inline">
					    <small class="muted smaller-90">是:</small>
						<input type="radio" name="product.isMarketable" class="ace" value="true"<#if (product.isMarketable == true)!> checked</#if> />
						<span class="lbl middle"></span>
					</label>
					...
					<label class="pull-left inline">
					    ...
					    <small class="muted smaller-90">否:</small>
						<input type="radio" name="product.isMarketable" class="ace" value="false"<#if (isAdd || product.isMarketable == false)!> checked</#if> />
						<span class="lbl middle"></span>
					</label> 
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<textarea name="product.metaDescription" class="formTextarea" cols="100">${(product.metaDescription)!}</textarea>
					</td>
				</tr>
			</table>
