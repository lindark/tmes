						...
						<div class="profile-user-info profile-user-info-striped">
								...
								<option value="2">
									...
									<div class="profile-info-row">
									    ...
									    <div class="profile-info-value">
											<input type="text" name="quality.createDate" value="${(quality.createDate)!}" class="formText {required: true} datePicker"/>
										</div>
										<div class="profile-info-name"> 计划完成时间 </div>
									    <div class="profile-info-value">
											<input type="text" name="quality.overTime" value="${(quality.overTime)!}" class="formText {required: true} datePicker" />
										</div>
									</div> 
									<div class="profile-info-row">
