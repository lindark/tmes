jQuery(function($) {
	...
	//	url:"kaoqin!historylist.action",
		...
		colModel:[
			...
			{name:'xfactoryUnit',label:"工厂",width:100,editable: false,search:false,sortable:false},
			{name:'xWorkshop',label:"车间",width:70,editable: false,search:false,sortable:false},
			{name:'productDate',label:"生产日期",width:100,editable: false,search:false,sortable:false},
			{name:'xfactoryUnit',label:"单元",width:70,editable: false,search:false,sortable:false},
