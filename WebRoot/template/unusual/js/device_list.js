...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
			...
			{name:'maintenanceType',index:'maintenanceType', width:60, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
			{name:'faultCharacter',index:'faultCharacter', width:60, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
			{name:'diagnosis',index:'diagnosis', width:60, sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"10"}},
