					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="searchform"
								action="enteringware_house!historylist.action" role="form">
								<div class="operateBar">
                                    ...
                                    <label class="col-sm-1 col-md-offset-1" style="text-align:right">状态:</label>
									  <div class="col-sm-4">
										...
										<label class="col-sm-1 col-md-offset-1" style="text-align:right">检验日期:</label>
										<div class="col-sm-4">
...
<script type = "text/javascript">
  $(function(){
	   ...
	   $excelReport.click(function(){
		   $searchform.attr("action","enteringware_house!excelexport.action");
		   $searchform.submit();
	   });	   
