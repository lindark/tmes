...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/unitdistributemodellist.js"></script>
				...
				<div class="page-content">
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" id="searchform" action="unitdistribute_model!ajlist.action" role="form">
								   <div class="operateBar">
								   <div class="form-group">
										<label class="col-sm-1 col-md-offset-1" style="text-align:right">单元名称:</label>
										<div class="col-sm-4">
											<input type="text" name="unitName" class="input input-sm form-control" value="" id="form-field-icon-1">
										</div>
