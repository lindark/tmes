...
<script type="text/javascript"
	src="${base}/template/admin/js/manage/sample_history.js"></script>
<script type="text/javascript"
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="searchform" method="post"
								action="sample!historylist.action" role="form">
								...
								<div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-1 col-md-offset-1"style="text-align:right">抽检人:</label>
										<div class="col-sm-4">
											<input type="text" name="xsampler"
												class="input input-sm form-control" value=""
												id="form-field-icon-1">
										</div>
                                    ...
                                    <label class="col-sm-1 col-md-offset-1"style="text-align:right">确认人:</label>
										<div class="col-sm-4">
											<input type="text" name="xcomfirmation"
												class="input input-sm form-control" value=""
												id="form-field-icon-1">
										</div>
...
<script type ="text/javascript">
   $(function(){
	   ...
	   $excelReport.click(function(){
		   $searchform.attr("action","sample!excelexport.action");
		   $searchform.submit();
	   });	   
   })
