									...
									<div id="tabs-1">
										...
										<div class="profile-user-info profile-user-info-striped">
											...
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<#if isAdd??> <input type="text" name="unitdistributeProduct.materialCode"
														value="${(unitdistributeProduct.materialCode)!}"
														class=" input input-sm  formText {required: true,minlength:2,maxlength: 100}" />
													<label class="requireField">*</label>
												    <#else>
													${(unitdistributeProduct.materialCode)!} <input type="hidden"
														name="unitdistributeProduct.materialCode"
														value="${(unitdistributeProduct.materialCode)!}" /> </#if> 											
												</div>
											</div>
