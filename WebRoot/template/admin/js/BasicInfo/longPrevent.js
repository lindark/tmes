jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"longtime_preventstep!ajlist.action",
		datatype: "json",
		...
		colModel:[
			...
			{name:'discribe',index:'discribe', width:200,editable: true,sortable:true},			
		...
		editurl: "longtime_preventstep!delete.action",//用它做标准删除动作
		caption: "长期预防措施管理"
	...
	jQuery(grid_selector).jqGrid('navGrid',pager_selector,
		{ 	//navbar options
		    ...
		    editfunc:function(rowId){
			    ...
			    window.location.href="longtime_preventstep!edit.action?id="+rowId;
		    },
			editicon : 'ace-icon fa fa-pencil blue',
			//add: true,
			addfunc:function(){
				window.location.href="longtime_preventstep!add.action";
			},
