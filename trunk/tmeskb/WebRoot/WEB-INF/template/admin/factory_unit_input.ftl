									...
									<div class="profile-info-row">
										...
										<div class="profile-info-value">
											<label class="pull-left inline">
						                       ...
						                       <input type="radio" class="ace" name="factoryUnit.state" value="factoryUnit.state"<#if (factoryUnit.state == '1')!> checked</#if> />
						                       <span class="lbl middle"></span>
						                         &nbsp;&nbsp;
					                        </label>						
					                        <label class="pull-left inline">
					                            <small class="muted smaller-90">未启用:</small>
						                        <input type="radio" class="ace" name="factoryUnit.state" value="factoryUnit.state"<#if (isAdd || factoryUnit.state == '2')!> checked</#if>  />
						                         <span class="lbl middle"></span>
					                        </label>		
										</div>	
									</div>							
