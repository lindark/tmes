...
public class ReworkAction extends BaseAdminAction {
	...
	public String ajlist(){
		...
		if (pager.is_search() == true && Param != null) {// 普通搜索功能
			...
			pager = reworkService.getReworkPager(pager, map);
	...
	public String delete(){
		...
		redirectionUrl = "rework!list.action";
		return SUCCESS;
	}
	...
	//更新
		...
		public String update() {
			...
			BeanUtils.copyProperties(rework, persistent, new String[] { "id","createDate", "modifyDate"});
