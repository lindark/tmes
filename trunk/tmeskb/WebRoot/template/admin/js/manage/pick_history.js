	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[		
	       ...
	       // {name:'cqPickAmount',index:'cqPickAmount',label:"裁切领退数", width:60,sortable:"true",sorttype:"text"},
	        {name:'materialCode',index:'materialCode',label:"物料编码", width:70,sortable:"true",sorttype:"text"},
	        {name:'materialName',index:'materialName',label:"物料描述", width:100,sortable:"true",sorttype:"text"},
