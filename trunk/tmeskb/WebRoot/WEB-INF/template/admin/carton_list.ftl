					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row buttons col-md-8 col-sm-4">
								<a id="addCarton" class="btn btn-white btn-default btn-sm btn-round access" data-access-list="cartonAdd">
									<i class="ace-icon fa fa-folder-open-o"></i>
									创建纸箱收货单
								</a>
								<a id="confirmCarton" class="btn btn-white btn-default btn-sm btn-round access" data-access-list="cartonConfirm">
									<i class="ace-icon fa fa-cloud-upload"></i>
									刷卡确认
								</a>
								<a id="undoCarton" class="btn btn-white btn-default btn-sm btn-round access" data-access-list="cartonUndo">
