jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
			...
			{name:'createDate',index:'createDate',label:"日期",width:120, editable: false,sorttype:"date",unformat:pickDate,formatter:datefmt},
			{name:'cardNum',index:'cardNum',label:"员工卡号",width:120, editable: false},
			{name:'empName',index:'empName',label:"员工姓名",width:120, editable: false},
			{name:'skill',index:'skill',label:"技能",width:120, editable: false},
			{name:'teams',index:'teams',label:"班组",width:120, editable: false},
			{name:'classtime',index:'classtime',label:"班次",width:120, editable: false},
