...
<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">资源管理&nbsp;<span class="pageInfo">总记录数: ${pager.totalCount}(共${pager.pageCount}页)</span></li>
		</ul><!-- /.breadcrumb -->
	</div>
	...
	<div class="page-content">
		...
		<form id="listForm" class="pdl10" action="resource!list.action" method="post">
...
<label class="label label-xlg label-white" style="background-color:#fff!important;color:#777;">每页显示:</label>
			...
			<#if (pager.list?size > 0)>
				<div class="pagerBar">
					<input type="button" class="deleteButton btn btn-white btn-default btn-sm btn-round " url="resource!delete.action" value="删 除" disabled hidefocus="true" />
