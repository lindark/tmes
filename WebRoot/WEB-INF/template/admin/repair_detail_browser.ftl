...
<link href="${base}/template/admin/css/input.css" rel="stylesheet"
	type="text/css" />
<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/processbrowser.js"></script>
							...
							<form class="form-horizontal" id="searchform"
								...
								<div class="operateBar">
									 <div class="form-group">
										<label class="col-sm-2" style="text-align:right">工序编码:</label>
										<div class="col-sm-4">
