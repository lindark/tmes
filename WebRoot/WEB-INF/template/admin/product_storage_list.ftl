...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/productstorage_list.js"></script>
	...
	<div class="page-content">
					<div class="page-content-area">					
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- ./ add by weitao  -->
									<form class="form-horizontal" id="searchform" action="product_storage!ajlist.action" role="form">
								   ...
								   <div class="operateBar">
										...
										<div class="col-sm-4">
											<div class="input-daterange input-group">
												<input type="text" class="input-sm form-control datePicker" name="accountDateStart" id="accountDateStart">
												<span class="input-group-addon">
													<i class="fa fa-exchange"></i>
												</span>

												<input type="text" class="input-sm form-control datePicker" name="accountDateEnd" id="accountDateEnd">
											</div>
										</div>
									
										
									<div class="form-group">	
										<label class="col-sm-2" style="text-align:right">物料编码:</label>
										<div class="col-sm-4">
											<input type="text" name="matnr" class="input input-sm form-control" value="" id="matnr">
										</div>
									</div>	
										...
										<div class="col-sm-4">
											<div class="input-daterange input-group">
												<input type="text" class="input-sm form-control datePicker" name="createDateStart" id="createDateStart">
												<span class="input-group-addon">
													<i class="fa fa-exchange"></i>
												</span>

												<input type="text" class="input-sm form-control datePicker" name="createDateEnd" id="createDateEnd">
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="aufnr" class="input input-sm form-control" value="" id="aufnr">
										</div>
									</div>
									...
									<div class="form-group" >
										<label class="col-sm-2" style="text-align:right">库存地点:</label>
										<div class="col-sm-4">
											<input type="text" name="lgort" class="input input-sm form-control" value="" id="lgort">
										</div>
									</div>
...
<script>
	...
	$(function() {
		...
		$syncButton.click(function() {
			//btn_addbug_event();
			var accountDateStart=$("#accountDateStart").val();
			var accountDateEnd=$("#accountDateEnd").val();
