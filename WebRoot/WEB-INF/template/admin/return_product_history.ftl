...
<script type="text/javascript"
	src="${base}/template/admin/js/manage/return_history.js"></script>
<script type="text/javascript"
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" id="searchform"
								action="return_product!historylist.action" role="form">
								<div class="operateBar">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="materialDesp"
												class="input input-sm form-control" value=""
												id="form-field-icon-1">
										</div>
									</div>
									...
									<label class="col-sm-1 col-md-offset-1" style="text-align:right">状态:</label>
									  ...
									  <label class="col-sm-1 col-md-offset-1" style="text-align:right">入库日期:</label>
										<div class="col-sm-4">
  ...
  $(function(){
	  var $excelReport = $("#excelReport");
	   ...
	   $excelReport.click(function(){
		   $searchform.attr("action","return_product!excelexport.action");
		   $searchform.submit();
	   });	   
