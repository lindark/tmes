	...
	jQuery(grid_selector).jqGrid(
			{
				...
				url : "product_group!ajlist.action",
				datatype : "json",
				// mtype:"POST",//提交方式
				...
				editurl: "product_group!delete.action",//用它做标准删除动作
				caption : "产品组管理"
	...
	jQuery(grid_selector).jqGrid(
			...
			{ // navbar options
				...
				editfunc : function(rowId) {
					window.location.href = "product_group!edit.action?id=" + rowId;
				},
				editicon : 'ace-icon fa fa-pencil blue',
				// add: true,
				addfunc : function() {
					window.location.href = "product_group!add.action";
				},
				addicon : 'ace-icon fa fa-plus-circle purple',
				del: true,
				/*delfunc : function(rowId) {
					window.location.href = "product_group!delete.action?id=" + rowId;
				},*/
