jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"unit_conversion!ajlist.action",
		datatype: "json",
		...
		colNames:[ 'ID','创建日期','单位编码','单位描述','兑换比例','转换单位','状态', ],
		colModel:[
	...
	jQuery(grid_selector).jqGrid('navGrid',pager_selector,
		{ 	//navbar options
		    ...
		    editfunc:function(rowId){
			    window.location.href="unit_conversion!edit.action?id="+rowId;
		    },
			editicon : 'ace-icon fa fa-pencil blue',
			//add: true,
			addfunc:function(){
				window.location.href="unit_conversion!add.action";
			},
			addicon : 'ace-icon fa fa-plus-circle purple',
			//del: true,
			delfunc:function(rowId){
				window.location.href="unit_conversion!delete.action?id="+rowId;
			},
