...
public class RepairinServiceImpl extends BaseServiceImpl<Repairin, String>
	...
	public void updateMyData(Repairin repairin,String cardnumber,int my_id,String wbid)
	{
		...
		if(my_id==1)
		{
			...
			Double d1=ArithUtil.add(wb.getRepairamount(),repairin.getReceiveAmount());//返修,返修收货共用数量
			Double d2=ArithUtil.add(wb.getTotalRepairinAmount(),repairin.getReceiveAmount());//投入产出
