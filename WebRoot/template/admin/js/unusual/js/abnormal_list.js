jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({		
		...
		colModel:[
			...
			{name:'log',index:'log', width:100,search:false,editable: true},
			{name:'callReason',index:'callReason',search:false, width:50, editable: true},
			{name:'originator',index:'iniitiator.name', width:40, editable: true,search:false},
			{name:'answer',index:'answer', width:40,search:false,editable: true},
			{name:'closeOrcancel',index:'closeOrcancel', width:40,search:false,editable: true},			
			{name:'stateRemark',index:'state', width:40,editable: true, sortable:true,cellattr:addstyle,sorttype:"local",stype:"select",searchoptions:{dataUrl:"dict!getDict1.action?dict.dictname=abnormalState"}},
			{name:'state',index:'state', width:40,editable: true,hidden:true},
