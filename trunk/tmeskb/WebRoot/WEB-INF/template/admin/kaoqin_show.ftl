...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/kaoqin_show.js"></script>
				...
				<div class="page-content">
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" id="searchform" action="team!ajlist.action" role="form">
								   ...
								   <div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="teams" class="input input-sm form-control" value="" id="form-field-icon-1">
										</div>
							...
							<div class="row buttons col-md-8 col-sm-4 btn_back">
									<a onclick="javascript:window.history.back(-1)" class="btn btn-white btn-default btn-sm btn-round">
