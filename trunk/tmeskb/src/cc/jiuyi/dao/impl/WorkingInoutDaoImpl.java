	...
	public List<String[]> sumAmount(String aufnr,String unit,String start,String end,List<String[]> processList) {
		...
		if(processList!=null){
			...
			String sql3 = "SELECT JSSJ2.*,DECODE(SUBSTR(JSSJ2.MATERIALCODE,0,1),'5',JSSJ2.RKS*JSSJ2.YL,(JSSJ2.RKS+JSSJ2.LTZCJX+JSSJ2.LTYCJX-JSSJ2.LTZCJS-JSSJ2.LTYCJS)*JSSJ2.YL+JSSJ2.FXFHMT-JSSJ2.FXSHMT+JSSJ2.BFS) CCZSL,TO_CHAR(DECODE(SIGN(JSSJ2.JHS),1,ROUND((JSSJ2.SCS/JSSJ2.JHS*100),2),0),'fm999999990.999999999')||'%' JHDCL "
					...
					+ "("
					+ "SELECT ZZDS.WITID,ZZDS.WBID,ZZDS.WORKCENTER,ZZDS.TEAMNAME,ZZDS.FUZHUREN,ZZDS.ZHUREN,ZZDS.MINISTER,ZZDS.DEPUTY,ZZDS.PRODUCTDATE,ZZDS.SHIFT,ZZDS.AUFNR,ZZDS.MATNR,ZZDS.MAKTX,ZZDS.MATERIALCODE,ZZDS.MATERIALNAME,ZZDS.WORKINGBILLCODE,ZZDS.JHS,EHS.STM RKS, ZZDS.BFS ,ZZDS.BGS,ZZDS.TMID,ZZDS.JJZT FROM "
					+ "(SELECT WIT3.ID WITID,WB1.ID WBID,WB1.WORKCENTER,WB1.TEAMNAME,WB1.FUZHUREN,WB1.ZHUREN,WB1.MINISTER,WB1.DEPUTY,WB1.PRODUCTDATE,WB1.SHIFT,WB1.AUFNR,WB1.MATNR,WB1.MAKTX,WIT3.MATERIALCODE,WIT3.MATERIALNAME,WB1.WORKINGBILLCODE,DECODE(SIGN(WB1.PLANCOUNT),1,WB1.PLANCOUNT,0) JHS,ROUND(DECODE(SIGN(WIT3.SCRAPNUMBER),1,WIT3.SCRAPNUMBER,0),3) BFS ,DECODE(SIGN(WB1.DAILYWORKTOTALAMOUNT),1,WB1.DAILYWORKTOTALAMOUNT,0) BGS,WB1.TMID,DECODE(WB1.ISHAND,'Y','已交接完成','未交接完成') JJZT  "
