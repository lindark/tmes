...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/manage/sark_recordList.js"></script>
		...
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-content-area">
					...
					<div class="row">
						<div class="col-xs-12">
						<form class="form-horizontal" id="searchform" action="sark!ajlist.action?isRecord=${(isRecord)!''}" role="form">
						<div class="operateBar">
							...
							<!-- <div class="row buttons col-md-8 col-sm-4">
								...
								<a id="returnSark" class="btn btn-white btn-default btn-sm btn-round">
