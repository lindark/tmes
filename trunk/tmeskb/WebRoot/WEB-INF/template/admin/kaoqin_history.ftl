...
<!--modify weitao-->
<script type="text/javascript"src="${base}/template/admin/js/BasicInfo/kaoqin_history.js"></script>
								...
								<div class="operateBar">
									<div class="form-group">
										<label class="col-sm-1 col-md-offset-1"
											style="text-align:right">生产日期:</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-1 col-md-offset-1" style="text-align:right">班次:</label>
									  <div class="col-sm-4">
										...
										<label class="col-sm-1 col-md-offset-1"
											style="text-align:right">单元:</label>
										<div class="col-sm-4">
...
<script type="text/javascript">
     $(function(){
    	 ...
    	 $excelReport.click(function(){
    		 $searchform.attr("action","kaoqin!excelexport.action");
  		     $searchform.submit();
    	 });
     })
