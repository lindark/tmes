jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"unitdistribute_product!ajlist.action",
		datatype: "json",
		...
		editurl: "unitdistribute_product!delete.action",//用它做标准删除动作
		caption: "单元分配产品管理"
	...
	jQuery(grid_selector).jqGrid('navGrid',pager_selector,
		{ 	//navbar options
		    ...
		    editfunc:function(rowId){
			    ...
			    window.location.href="unitdistribute_product!edit.action?id="+rowId;
		    },
			editicon : 'ace-icon fa fa-pencil blue',
			//add: true,
			addfunc:function(){
				window.location.href="unitdistribute_product!add.action";
			},
