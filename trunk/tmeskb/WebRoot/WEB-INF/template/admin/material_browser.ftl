...
<title>组件信息- Powered By
	${systemConfig.systemName}</title>
<link rel="icon" href="favicon.ico" type="image/x-icon" />
<#include "/WEB-INF/template/common/includelist.ftl">
<link href="${base}/template/admin/css/input.css" rel="stylesheet"
	type="text/css" />
<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/materialbrowser.js"></script>
...
<script type="text/javascript">
	function getGridId(){
		...
		var rowUnit=rowData.materialUnit;
		var rowAmount=rowData.materialAmount;
		//alert(rowName);
		//alert(ids);
		var work=""+rowName+""+","+ids+""+","+rowCode+""+","+rowUnit+""+","+rowAmount;
		//alert("work=-----------------------"+work);
		return work;
	}
