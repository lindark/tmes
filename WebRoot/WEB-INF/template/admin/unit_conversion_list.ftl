...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="${base}/template/admin/js/BasicInfo/unitConversion.js"></script>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" id="searchform" action="unitConversion!ajlist.action" role="form">
								   ...
								   <div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="unitCode" class="input input-sm form-control" value="" id="form-field-icon-1">
										</div>
