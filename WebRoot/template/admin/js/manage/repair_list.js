...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"repair!ajlist.action?workingBillId="+workingBillId,
		datatype: "json",
		//mtype:"POST",//提交方式
		...
		colModel:[
			...
			{name:'createDate',label:"返修日期",index:'createDate',width:100,sortable:"true",sorttype:"date",unformat: pickDate,formatter:datefmt},
			{name:'responseName',label:"责任工序",index:'responseName', width:100,sortable:"true",sorttype:"text"},
			{name:'duty',label:"责任人",index:'duty', width:100,sortable:"true",sorttype:"text"},
			{name:'charg',label:"批次",index:'charg', width:100,sortable:"true",sorttype:"text"},
