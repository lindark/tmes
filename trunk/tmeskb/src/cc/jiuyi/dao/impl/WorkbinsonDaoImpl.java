 ...
 */
@Repository
public class WorkbinsonDaoImpl extends BaseDaoImpl<WorkbinSon, String> implements WorkbinsonDao
{
...
//					end = DateUtils.addDays(end, 1);
	...
	public List<Object[]> historyExcelExport(HashMap<String, String> map) {
			String hql="from WorkbinSon model join model.carton model1";
			Integer ishead=0;
