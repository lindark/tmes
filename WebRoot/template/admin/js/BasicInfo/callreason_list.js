	...
	jQuery(grid_selector).jqGrid(
			{
				...
				editurl: "callreason!delete.action",//用它做标准删除动作
				caption : "呼叫原因"
	...
	jQuery(grid_selector).jqGrid(
			...
			{ // navbar options
				...
				editfunc : function(rowId) {
					window.location.href = "callreason!edit.action?id=" + rowId;
				},
				editicon : 'ace-icon fa fa-pencil blue',
				// add: true,
				addfunc : function() {
					window.location.href = "callreason!add.action";
				},
